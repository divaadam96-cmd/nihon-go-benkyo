...
function materialsPage(){return '<section class="embedded-feature"><div class="feature-loading">Memuat fitur Materi lengkap…</div><iframe class="feature-frame" data-feature="materials" src="index.html?build=28&source=1" title="Materi pembelajaran Nihon GO Benkyo"></iframe></section>'}
function kanjiPage(){return '<section class="embedded-feature"><div class="feature-loading">Memuat fitur Kanji interaktif…</div><iframe class="feature-frame" data-feature="kanji" src="prototype-kanji-v2.html?v=10&embed=1" title="Belajar Kanji interaktif"></iframe></section>'}
function memoryPage(){return '<section class="embedded-feature"><div class="feature-loading">Memuat halaman Hafalan asli…</div><iframe class="feature-frame" data-feature="memory" src="index.html?build=28&source=1" title="Hafalan Nihon GO Benkyo"></iframe></section>'}
function examPage(){return `${hero("SIMULASI UJIAN","Tes Kemampuan","Pilih simulasi JLPT atau JFT-Basic. Bank soal lokal sudah siap digunakan.")}<section class="exam-routes-preview"><a class="route-preview" href="prototype-tes-v2.html?v=4&exam=jlpt&embed=1"><span>試</span><b>Simulasi JLPT</b><small>Kosakata, kanji, tata bahasa, bacaan, dan audio.</small><span class="waiting-badge ready-badge">Bank soal aktif</span></a><a class="route-preview" href="prototype-tes-v2.html?v=4&exam=jft&embed=1"><span>会</span><b>Simulasi JFT-Basic</b><small>Komunikasi praktis, bacaan, dan audio situasional.</small><span class="waiting-badge ready-badge">Bank soal aktif</span></a></section><div class="exam-note"><b>Simulasi siap digunakan.</b> Soal dibuat dari data kosakata, kanji, tata bahasa, dan konteks pembelajaran lokal.</div>`}
