const CACHE_NAME = 'nihon-go-benkyo-v117';
const ASSETS = [
  'index.html',
  ...
  'js/app-shell.js?v=3', 'js/app-sidebar.js?v=2', 'js/app-effects.js?v=5', 'js/quiz-results.js?v=2', 'js/srs.js?v=5', 'js/auth.js?v=7', 'js/assignments.js?v=5', 'js/pwa.js?v=2',
  'js/pages/dashboard.js?v=1',
  'nihon-go-benkyo.webmanifest',
  'assets/icons/icon-192.png', 'assets/icons/icon-512.png', 'assets/icons/icon-maskable-512.png',
  'pages/materi.html?v=2', 'js/pages/materi.js?v=2',
  'pages/hafalan.html?v=2', 'js/pages/hafalan.js?v=1',
  ...
  'pages/pantau.html?v=4', 'css/pages/pantau.css?v=2', 'js/pages/pantau.js?v=3',
