...
if (new URLSearchParams(location.search).get("source") !== "1") {
  ...
  if (materialsView) {
    materialsView.innerHTML = '<iframe class="production-material-frame" data-src="prototype-materi.html?v=3" title="Materi pembelajaran fokus" loading="lazy"></iframe>';
...
if ("serviceWorker" in navigator && location.protocol !== "file:")
  navigator.serviceWorker.register("sw.js?build=25").catch(() => {});
