...
(function mountKanjiLearningV2() {
  ...
  if (!view) return;
  view.innerHTML =
    '<iframe class="production-kanji-frame" data-src="prototype-kanji-v2.html?v=13&embed=1" title="Belajar Kanji interaktif" allow="fullscreen" allowfullscreen loading="lazy"></iframe>';
