...
function updatePackagePreview(){
  ...
  $("selectedTestName").textContent=`Ujian per 5 Bab · Bab ${rangeStart}–${rangeStart+4}`;$("selectedRangeText").textContent=`Materi gabungan diambil dari Bab ${rangeStart}, ${rangeStart+1}, ${rangeStart+2}, ${rangeStart+3}, dan ${rangeStart+4}.`;$("heroExamType").textContent="Per 5 Bab";$("heroPackage").textContent=`Bab ${rangeStart}–${rangeStart+4}`}
